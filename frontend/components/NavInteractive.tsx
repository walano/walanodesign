...
export default function NavInteractive({ children }: { children?: ReactNode }) {
  ...
  /* ── Detect homepage (client-only, no usePathname to avoid SSR bailout) ── */
  useEffect(() => {
    const home = window.location.pathname === "/";
    setIsHome(home);
    if (home) setVisible(false);
  }, []);
