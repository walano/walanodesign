...
const fr: LegalContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.6rem" }}>Ces données sont collectées uniquement lorsque le client les transmet volontairement via le formulaire de devis, par email ou par messagerie.</p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.6rem" }}>Walano design ne commercialise pas, ne vend pas et ne transmet pas les données personnelles de ses clients à des tiers.</p>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.4rem" }}>Pour exercer ces droits, le client peut contacter Walano Design à l'adresse : <a href="mailto:contact@walanodesign.com" style={{ color: "#855c9d", textDecoration: "none" }}>contact@walanodesign.com</a>.</p>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          <p>Le site est hébergé par vercel inc., 340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis (<a href="https://vercel.com" style={{ color: "#855c9d", textDecoration: "none" }}>https://vercel.com</a>). Les images du portfolio sont hébergées par cloudinary ltd. (<a href="https://cloudinary.com" style={{ color: "#855c9d", textDecoration: "none" }}>https://cloudinary.com</a>).</p>
        </>
      ),
    },
    {
...
const en: LegalContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.6rem" }}>This data is collected only when the client voluntarily submits it through the quote form, by email or by messaging.</p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.6rem" }}>Walano design does not sell, trade or transfer its clients' personal data to third parties.</p>
        </>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.4rem" }}>To exercise these rights, the client may contact Walano Design at: <a href="mailto:contact@walanodesign.com" style={{ color: "#855c9d", textDecoration: "none" }}>contact@walanodesign.com</a>.</p>
        </>
      ),
    },
    {
    ...
    },
    {
      title: "7. Hosting",
      body: (
        <p>The site is hosted by vercel inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA (<a href="https://vercel.com" style={{ color: "#855c9d", textDecoration: "none" }}>https://vercel.com</a>). Portfolio images are hosted by cloudinary ltd. (<a href="https://cloudinary.com" style={{ color: "#855c9d", textDecoration: "none" }}>https://cloudinary.com</a>).</p>
      ),
    },
    {
      title: "8. Security",
