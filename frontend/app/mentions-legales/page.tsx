    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.5rem" }}>Vercel Inc.<br />340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis<br /><a href="https://vercel.com" style={{ color: "#855c9d", textDecoration: "none" }}>https://vercel.com</a></p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.5rem" }}>Toute reproduction, représentation, modification, publication, adaptation ou diffusion de tout ou partie des éléments du site, quel que soit le moyen ou le procédé utilisé, est interdite sans autorisation écrite préalable de Walano Design.</p>
          <p style={{ marginTop: "0.5rem" }}>Les créations présentées dans le portfolio sont protégées par le droit d'auteur conformément à la convention de Berne. Elles ne peuvent être téléchargées, copiées, reproduites ou utilisées à quelque fin que ce soit sans accord express.</p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.5rem" }}>Toute utilisation non autorisée de ces images constitue une violation du droit d'auteur et pourra faire l'objet de poursuites.</p>
        </>
      ),
    },
    {
      ...
      body: (
        <p>Les prestations proposées par Walano Design sont régies par les <a href="/conditions" style={{ color: "#855c9d", textDecoration: "none" }}>conditions générales de vente</a>.</p>
      ),
    },
    {
      title: "Politique de confidentialité",
      body: (
        <p>La collecte et le traitement des données personnelles sont décrits dans la <a href="/confidentialite" style={{ color: "#855c9d", textDecoration: "none" }}>politique de confidentialité</a>.</p>
      ),
    },
    {
    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.5rem" }}>Vercel Inc.<br />340 S Lemon Ave #4133, Walnut, CA 91789, USA<br /><a href="https://vercel.com" style={{ color: "#855c9d", textDecoration: "none" }}>https://vercel.com</a></p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.5rem" }}>Any reproduction, representation, modification, publication, adaptation or distribution of all or part of the elements on the site is prohibited without prior written authorization from Walano Design.</p>
          <p style={{ marginTop: "0.5rem" }}>The creations presented in the portfolio are protected by copyright in accordance with the Berne Convention. They may not be downloaded, copied, reproduced or used for any purpose without express agreement.</p>
        </>
      ),
    },
    {
      ...
      body: (
        <>
          ...
          <p style={{ marginTop: "0.5rem" }}>Any unauthorized use of these images constitutes a copyright violation and may be subject to legal action.</p>
        </>
      ),
    },
    {
      ...
      body: (
        <p>The services offered by Walano Design are governed by the <a href="/conditions" style={{ color: "#855c9d", textDecoration: "none" }}>general terms and conditions of sale</a>.</p>
      ),
    },
    {
      title: "Privacy Policy",
      body: (
        <p>The collection and processing of personal data are described in the <a href="/confidentialite" style={{ color: "#855c9d", textDecoration: "none" }}>privacy policy</a>.</p>
      ),
    },
    {
      title: "Liability",
